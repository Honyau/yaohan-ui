<template>
  <div id="carousel">
    <div class="window" @mouseover="stop" @mouseleave="play">
      ...
      <ul class="dots" v-if="point" ref="refDots">
        <li
...
export default {
  ...
  props: {
    ...
    sliders: {
      ...
      default: () => [
        {
          img:
            'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fcdn.duitang.com%2Fuploads%2Fitem%2F201202%2F18%2F20120218194349_ZHW5V.thumb.700_0.jpg&refer=http%3A%2F%2Fcdn.duitang.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1623571283&t=404c98966db279854a9bedc359f5fc1a',
        },
        {
          img:
            'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fcdn.duitang.com%2Fuploads%2Fitem%2F201410%2F04%2F20141004172507_J8Mty.jpeg&refer=http%3A%2F%2Fcdn.duitang.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1623571337&t=bfe06e92fd14bc3f2faee4c8a913e5d3',
        },
        {
          img:
        ...
        {
          img:
            'https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=4152737816,990173897&fm=224&gp=0.jpg',
        },
      ],
    },
  },
  ...
  methods: {
    ...
    // 设置小圆点颜色
    setDotColor() {
      if (!this.dotsInactiveColor && this.dotsActiveColor) return

      let color = this.dotsInactiveColor && this.dotsInactiveColor

      this.$nextTick(() => {
        let dots = Array.from(this.$refs.refDots.childNodes)
        dots.forEach((li) => {
          if (li.className)
            li.style.backgroundColor = this.dotsActiveColor
              ? this.dotsActiveColor
              : ''
          else li.style.backgroundColor = color
        })
      })
    },
  },
